...
local trad "b_total_hits b_home_run b_strikeout b_walk batting_avg slg_percent on_base_percent on_base_plus_slg" 
...
esttab eq1 eq2 eq3 eq4 eq5 eq6 eq7 using "regressionstable2.tex"
