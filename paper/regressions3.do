...
reg ln_salary war `trad' age nonwhite year
...
reg ln_salary war servicetime nonwhite `sabr'
estimates store eq3

reg ln_salary war servicetime nonwhite year `sabr'
estimates store eq4

reg ln_salary war servicetime nonwhite `trad' tm_dummy* if tm_dummy1 != 1
estimates store eq5

reg ln_salary war servicetime nonwhite `sabr' tm_dummy* if tm_dummy1 != 1
estimates store eq6

reg ln_salary war servicetime nonwhite `sabr' `trad' tm_dummy* if tm_dummy1 != 1
estimates store eq7

esttab eq1 eq2 eq3 eq4 eq5 eq6 eq7 using "regressionstable3.tex"
